...
const Index: FunctionalComponent<Props> = () => (
  <html lang="en">
    <head>
      <title>optimizeimg</title>
      <meta
        name="description"
        content="optimizeimg is the ultimate image optimizer that allows you to compress and compare images with different codecs in your browser."
      />
      <meta name="twitter:card" content="summary" />
      <meta name="twitter:site" content="@SquooshApp" />
      <meta property="og:title" content="optimizeimg" />
